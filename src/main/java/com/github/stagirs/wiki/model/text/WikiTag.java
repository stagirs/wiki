 ...
 */
public class WikiTag extends WikiText.Item{
    private String name;
    private Map<String, String> map;
    private WikiText body;

    public WikiTag(StringBuilder sb, String text, int rawPos, String rawText, String name, Map<String, String> map, WikiText body) {
